...
partial class Program
{
    ...
    static void AggregateProducts()
    {
        ...
        using (Northwind db = new())
        {
            ...
            WriteLine("{0,-27} {1,8}", arg0: "Product count:", arg1: db.Products.Count());

            WriteLine("{0,-25} {1,8}", // Note the different column widths.
            arg0: "Discontinued product count:",
            arg1: db.Products.Count(product => product.Discontinued));

            WriteLine("{0,-27} {1,8:$#,##0.00}",
