partial class Program
{
    ...
    static decimal CalculateTax(decimal amount, string twoLetterRegionCode)
    {
        ...
        rate = twoLetterRegionCode.ToUpper() switch
        {
            ...
            "DK" or "NO" => 0.08M, // Denmark, Norway
            "GB" or "FR" or "UK" => 0.2M, // United Kingdom, France
            "HU" => 0.27M, // Hungary
            "OR" or "AK" or "MT" => 0.0M, // Oregon, Alaska, Montana
            "ND" or "WI" or "ME" or "VA" => 0.05M, // North Dakota, Wiscosin, Maine, Virginia
...
/// </summary>
    ...
    /// 
    /// </summary>
    /// define a non-local static function
