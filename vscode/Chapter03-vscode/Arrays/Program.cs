...
WriteLine($"Lower bound of the first dimension is: {grid2.GetLowerBound(0)}");
WriteLine($"Upper bound of the first dimension is: {grid2.GetUpperBound(0)}");
WriteLine($"Lower bound of the second dimension is: {grid2.GetLowerBound(1)}");
WriteLine($"Upper bound of the second dimension is: {grid2.GetUpperBound(1)}");
